...
<head>
    ...
    <script src="https://desarrolloweb.com/articulos/ejemplos/prototype/prototype-1.6.0.3.js"></script>
  	<script type="text/javascript">
		function CalcularTotal()
		{
			...
			$.post("Calculadora_Prototype.php", {par1: par1, par2: par2, op: op}, function(resultado){
				$("#res").val(resultado);
			}, "json"); /*El parámetro "json" indica que la respuesta desde PHP es en formato JSON*/
		}
		
		function recibirAjaxActualizar(){
	new Ajax.Updater('contenidoajax', 'Calculadora_Prototype.php');
}	
</script>
...
<body>
  ...
  <form action="Calculadora_Prototype.php" method="POST">
    ...
    <tr>
     ...
     <tr>
		<td colspan="2" align="center">
		 <div id="contenidoajax">Resultado</div>
		</td>
    </tr>
